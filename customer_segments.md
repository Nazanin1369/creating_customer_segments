...
Based on the correlation graph following features has some degree of correlation:

* Milk & Detergents_Paper
* Grocery and Milk
* Frozen & Delicatessen

Data is not normally distributed since Mean and Median are vary significanty so based on the histogram most of the points lie between 
